// Добавлена световая индикация при запуске и настройках.
...
//#define PIN 5
#define PIN 2
#define count_led 20 // количество светодиодов 
...
String Status = "";
int Mode;
const char url[] = "http://ce05390-django.tw1.ru/api/v1/lamps/lamps/detail/1/?format=json";
